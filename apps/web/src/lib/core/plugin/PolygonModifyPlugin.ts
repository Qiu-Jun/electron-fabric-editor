...
const actionHandler: fabric.Control['actionHandler'] = function (
  ...
  const currentControl = polygon.controls[polygon.__corner] as PointIndexControl
...
function anchorWrapper(anchorIndex: number, fn: fabric.Control['actionHandler']) {
...
function polygonPositionHandler(this: PointIndexControl, dim: any, finalMatrix: any, fabricObject: any) {
