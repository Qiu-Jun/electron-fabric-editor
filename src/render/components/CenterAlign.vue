  ...
  <div class="attr-item-box" v-if="mixinState.mSelectMode">
    ...
    <div class="bg-item">
      ...
      <el-tooltip :content="$t('attrSeting.centerAlign.centerX')">
        <el-button :disabled="!mixinState.mSelectMode" @click="position('centerH')" link>
          <svg
            t="1650442559691"
            class="icon"
      ...
      <el-tooltip :content="$t('attrSeting.centerAlign.center')">
        <el-button :disabled="!mixinState.mSelectMode" @click="position('center')" link>
          <svg
            t="1650852784867"
            class="icon"
            viewBox="0 0 1024 1024"
      ...
      <el-tooltip :content="$t('attrSeting.centerAlign.centerY')">
        <el-button :disabled="!mixinState.mSelectMode" @click="position('centerV')" link>
          <svg
            t="1650442510967"
            class="icon"
            viewBox="0 0 1024 1024"
